...
<div class="cuerpo-usuarios">
  ...
  <div class="container">
    ...
    if (isset($_REQUEST['listado-pedidos-fecha']) && !empty($_REQUEST['listado-pedidos-fecha'])) {
        $pedidos = $_REQUEST['listado-pedidos-fecha'];
       
        
          
 ?>
        <h1 class="text-center">Listado de Pedidos por fecha </h1>
                <hr>
