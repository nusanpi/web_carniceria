<!DOCTYPE html>
<html lang="es">
<title>Pedidos por productos</title>
...
<div class="cuerpo-usuarios">
  ...
  <div class="container">
    ...
    if (isset($_REQUEST['listado-productos-desc']) && !empty($_REQUEST['listado-productos-desc'])) {
        $pedidos = $_REQUEST['listado-productos-desc'];
       
        
            $numero_producto = isset($pedidos[0]['producto']) ? $pedidos[0]['producto'] : "";

        echo "<h1 class='text-center'>Listado de Pedidos del producto: $numero_producto</h1>";
